...
linux-* {
	...
	QMAKE_CXXFLAGS *= -D_FILE_OFFSET_BITS=64 -Wall -W
	...
	LIBS += -lssl -lgpgme -lupnp -lixml -lgnome-keyring -lcrypto -ldl -lmenu -lncurses
}
...
HEADERS +=  notifytxt.h Menu.h Cli.h FriendsWindow.h ncurses-wrapper.h
SOURCES +=  retroshare-ncurses.cpp \
            notifytxt.cc \
						Menu.cpp \
						ClI.cpp \
						FriendsWindow.cpp
